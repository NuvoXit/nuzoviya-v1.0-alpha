    ...
    <svg viewBox={`-5 0 ${chartWidth + 10} ${chartHeight + 50}`} className="svg-chart">
      ...
      {points.map((p, index) => (
        <g key={index} className="chart-point-group">
          ...
          <text x={p.x} y={p.y - 12} textAnchor="middle" fontSize="10" fontWeight="700" fill="#1f2a1e" opacity="0" className="chart-point-label">
            {yLabelPrefix}
        ...
        <>
          ...
          <div className="dashboard-charts-grid">
            ...
            <div className="chart-card">
              ...
              <div className="chart-wrapper">
                <AreaLineChart data={revenuePerMonthData} xKey="month" yKey="revenue" color="#1f4d37" yLabelPrefix="Rs." gradientId="revenueGrad" />
              </div>
            </div>
          </div>
        </>
